...
public final class ItemMagnetPlaceholderExpansion extends PlaceholderExpansion {
    ...
    public ItemMagnetPlaceholderExpansion(ItemMagnetPlugin plugin, MagnetLocator magnetLocator) {
        this.plugin = plugin;
    ...
    public static void tryRegister(ItemMagnetPlugin plugin, MagnetLocator magnetLocator) {
        if (Bukkit.getPluginManager().getPlugin("PlaceholderAPI") == null) {
            return;
        }
        new ItemMagnetPlaceholderExpansion(plugin, magnetLocator).register();
    }
}
